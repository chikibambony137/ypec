    ...
    <div class="page">
        <header>
            ...
            <div class="refs-header">
                <div class="refs-header2">
                    ...
                    <div class="menu-bttn" @click="toggleMenu">
                        <div class="burger">
        ...
        <main>
            ...
            <div class="ad">
                ...
                <img src="../assets/ad1.png" width="50%">
            </div>
            <div class="body"></div>
        </main>
...
<style scoped>
    ...
    main {
        ...
        display: grid;
        grid-template-columns: 23% 50% 21%;
        grid-template-rows: 10% 21.9% 64.05%;
        grid-template-areas: 
            "menu swap aside"
            "menu ad ad"
            "body body body";
